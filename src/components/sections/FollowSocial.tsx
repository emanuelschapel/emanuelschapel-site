...
/**
 * Brand glyphs, drawn rather than loaded as image files: they inherit `currentColor` so
 * they take the palette and the hover state, stay sharp at any size, and cost no request.
 * Used only to link to the funeral home's own profiles.
 */
...
/**
 * Networks in display order. Anything without a URL is skipped, so an account the client
 * has not opened yet simply does not appear — no dead links, and turning one on is a
 * one-line edit in site.ts.
 */
const NETWORKS = [
  { key: 'instagram', label: 'Instagram', url: site.social.instagram.url },
  { key: 'facebook', label: 'Facebook', url: site.social.facebook.url },
