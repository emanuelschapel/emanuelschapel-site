 ...
 *         counter at the bottom carrying the lede. It deliberately carries NO call/immediate-need
 *         buttons — the Immediate Need section directly below repeats that pair, and the sticky
 *         availability bar already holds the number.
